class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.first = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'first').setOrigin(0, 1);
        this.second = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'second').setOrigin(0, 1);
        this.third = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'third').setOrigin(0, 1);
